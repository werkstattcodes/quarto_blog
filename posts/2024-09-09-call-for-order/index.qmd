...
txt_subtitle <- "Der vorsitzführende Nationalratspräsident/die vorsitzführende Nationalratspräsidentin kann, wenn ein/e RednerIn die Würde des Hohen Hauses beziehungsweise einer oder eines Abgeordneten verletzt, einen Ordnungsruf aussprechen. Daten dazu sind auf der Homepage des Parlaments ab der Legislaturperiode XX verfügbar. **Noch nie haben die Mitglieder einer Fraktion innerhalb einer Periode soviele Ordnungsrufe bekommen, wie jene der FPÖ in der vergangenen  Legislaturperiode XXVII.**"
...
pl_calls_legis_period <- pl_calls_legis_period+theme(plot.margin = margin(t = 20, r = 20, b = 20, l = 20, unit = "pt"))
...
pl_calls_legis_period_speaker <- pl_calls_legis_period_speaker+theme(plot.margin = margin(t = 20, r = 20, b = 20, l = 20, unit = "pt"))
...
Those privy to Austrian politics might be not surprised to see Herbert Kickl featuring most Calls to Orders since the beginning of the data record. The large difference to other MPs, even his party colleagues, I find, to put it mildly, rather remarkable.
...
theme(
  ...
  panel.grid.minor.y=element_blank(),
    ...
    legend.spacing.y=unit(0.1, unit="cm"),
    legend.direction = "horizontal",
    plot.caption.position="plot",
...
pl_calls_days_in_parl <- pl_calls_days_in_parl+theme(plot.margin = margin(t = 20, r = 20, b = 20, l = 20, unit = "pt"))
...
Like many others, I assume, I am not surprised to see the FPÖ and Herbert Kickl featuring a high number of Calls to Orders. The extent of the increase during the now closing 27th legislative period, however, was a surprise to me as was Kickl's record in comparison to other FPÖ MPs.
