...
So as it turns out, of the the `r nrow(df_calls)` Calls to Order which were issued since the start of the 20the legislative period, there has been only a single instance in which the call was issued for a member of the government bench, more precisely, the Minister of Interior. Let's get the name.
