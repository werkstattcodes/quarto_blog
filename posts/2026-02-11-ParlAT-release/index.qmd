...
| `get_plenary_meetings()` | Plenary session metadata |
...
The Federal Assembly (Bundesversammlung), which convenes for presidential inaugurations and similar joint sessions, can be queried by setting `institution = "BV"` and `legis_period = NULL`.
