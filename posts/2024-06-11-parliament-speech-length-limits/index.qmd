...
When it comes to initial interest of this post, speech limits, we saw that th vast majority of speeches are governed by voluntary time limit. 

The vast majority of speeches is subject to voluntary time limits. However, only a minority, around 36 % of all relevant speeches, de facto respect this limit. In other words, exceeding these limits and having a speech overtime is a rather prevalent. 
...
Does it matter? Respect for procedural rules. After all voluntary
limits. When are speech limits exceeded? On which occasions, which topic, in response to which preceding speaker? Non-respect of parliamentary norms; a party which is against the system; would be curious to compare it parties similar to the FPÖ in other parliaments;
