---
title: "Austria's Covid legislation: Duration of parliamentarian consultation period in comparison."
description: "A (relative) deep dive into the length of the public consultation period for draft bills in Austria, and whether three days for three pages are actually 'normal'."
...
# readr::write_csv2(df_bills_all, file=here::here("posts",
...
# readr::write_csv2(df_res, file=here::here("posts",
#                                           "2021-01-22-covidconsultationduration",
#                                           "df_res.csv"))
...
df_res <-  readr::read_csv2(file=here::here("posts", "2021-01-22-covidconsultationduration",
                                           "df_res.csv")) %>% 
...
# readr::write_excel_csv2(df_pages, file=here::here("posts", "2021-01-22-covidconsultationduration", "df_pages.csv"))

df_pages <- readr::read_csv2(here::here("posts", "2021-01-22-covidconsultationduration", "df_pages.csv"))
...
#                         file=here::here("posts", "2021-01-22-covidconsultationduration", "df_consolidated.csv"))

```

```{r message=FALSE, warning=FALSE, include=FALSE, code_folding=NULL}
df_consolidated <- readr::read_csv2(file=here::here("posts", "2021-01-22-covidconsultationduration", "df_consolidated.csv"))
...
# readr::write_excel_csv2(df_submissions_pages, file=here::here("posts", "2021-01-22-covidconsultationduration", "df_submissions_pages.csv"))
```

```{r GET_SUBMISSIONS_2, include=FALSE, eval=T, code_folding=NULL}
df_submissions_pages <- readr::read_csv2(file=here::here("posts",
                                                         "2021-01-22-covidconsultationduration", "df_submissions_pages.csv"))
...
```{r, fig.height=5, echo=F, code_folding=NULL, dev="svglite"}
pl_consolidated
```
...
```{r code_folding=NULL, echo=F}
knitr::include_graphics("rss_bills_overview.png")
```
...
readr::read_csv2(file=here::here("posts","2021-01-22-covidconsultationduration", "df_bills_all.csv")) %>% 
...
knitr::include_graphics("table_law_stages.png")
```
...
```{r fig.height=5, echo=F, code_folding=NULL, include=T}
knitr::include_graphics("example_multiple_periods.png")
```
