...
description: "With the re-opening of Austria's parliament earlier this year not only came a renovate building, but also a new API. This post looks into one of its endpoints which facilitates accessing data on MPs. Who has been the longest serving MP and how did the gender composition change over time, are among the questions addressed."
...
Note: For higher resolution images, please see plots in the blogpost.
...
df_gender %>%
  ...
  geom_richtext(
    ...
    label = "<span style='font-size:10pt; color:darkgrey;line-height:50%'>Austrian Nationalrat:</span><br> <span style='color:darkgrey;font-size:16pt'>Gender of MPs<br>since 1918</span>",
    hjust = 0,
    label.color = "white",
    label.r = unit(0, "lines"),
    label.padding = unit(0, "lines"),
...
## Gender composition at the start of the legislative period
