...
description: "Creating and analyzing a new dataset on the voting behavior of BiH's members of the House of Representatives."
...
![](record.PNG){width="100%" height="100%"}
...
df_ocr_results_unnested <- readr::read_csv2(here("posts", "2020-02-07-bih-voting-behavior-of-mps-in-house-of-representatives", "df_ocr_results_unnested.csv"))
...
As a general caveat, note that I took MPs' party affiliation as stated on the parliament's website which may omit instances in which MPs have changed their party affiliation in the course of the 2014-2018 legislative period. I am not aware that this was actually the case, but if so, please let me know.[^2]

[^2]: One way to improve the graph would be to have equally sized heights per MP.
...
Below the most important steps to obtain the results from above. The entire code for the (and more) is available at my github [*here*](https://github.com/werkstattcodes/2020-02-07-bih-voting-behavior-of-mps-in-house-of-representatives){target="_blank"}.
...
Below the main steps (see the full script at my repo [here.](https://github.com/werkstattcodes/2020-02-07-bih-voting-behavior-of-mps-in-house-of-representatives/blob/master/script/ocr_files.R){target="_blank"}).
...
my_link <- here::here("posts", "2020-02-07-bih-voting-behavior-of-mps-in-house-of-representatives","df_ocr_results_unnested.csv")
