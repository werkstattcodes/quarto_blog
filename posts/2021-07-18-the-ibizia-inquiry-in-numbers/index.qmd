...
image: overview_links_thumb.png
...
![](subpage_link_to_transcript.PNG)
...
```{r, cache=F, code_folding=F, eval=T}
...
```{r, cache=F, code_folding=F, eval=T, include=F}
...
```{r, cache=F, code_folding=F, eval=T, include=T}
...
```{r, cache=F, code_folding=T, eval=T}
...
```{r, cache=T, code_folding=F, echo=T, eval=F}
...
```{r, include=F, eval=T}
df_data_1 <- readr::read_csv2(file=here::here("posts", "2021-07-18-the-ibizia-inquiry-in-numbers",
...
![](geschaeftsbehandlung.png){height="200"}
