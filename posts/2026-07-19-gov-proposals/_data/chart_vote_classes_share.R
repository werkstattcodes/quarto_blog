...
p <- ggplot(df, aes(x = tagung, fill = class)) +
  ...
  geom_text(data = totals, aes(x = tagung, y = 1.05, label = n_laws),
  ...
  labs(title = "How laws passed the Nationalrat, 1996–2026",
       subtitle = "Share of federal laws by voting majority in the third reading, split by bill origin; parliamentary years (mid-Sept to mid-Sept).\nNumbers above bars: laws passed per year. 'Other' incl. caretaker period 2019 and missing vote records.",
...
ggsave("posts/2026-07-19-gov-proposals/_data/vote-classes-by-origin.png", p,
